...
public val NotekeeperIconPack.`Chevron-left-1`: ImageVector
    get() {
        if (`_chevron-left-1` != null) {
            return `_chevron-left-1`!!
        }
        `_chevron-left-1` = Builder(name = "Chevron-left-1", defaultWidth = 24.0.dp, defaultHeight =
...
private var `_chevron-left-1`: ImageVector? = null
