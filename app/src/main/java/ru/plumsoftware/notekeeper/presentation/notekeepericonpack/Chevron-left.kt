...
public val NotekeeperIconPack.`Chevron-left`: ImageVector
    get() {
        ...
        `_chevron-left` = Builder(name = "Chevron-left", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFFffffff)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.2318f, 2.8036f, 17.2512f, 2.9012f, 17.2512f, 2.9999f)
                ...
                curveTo(17.2508f, 21.199f, 17.1717f, 21.3901f, 17.0309f, 21.5309f)
                ...
                curveTo(6.899f, 12.4612f, 6.8436f, 12.3785f, 6.8058f, 12.2873f)
                curveTo(6.768f, 12.1962f, 6.7485f, 12.0985f, 6.7485f, 11.9999f)
                curveTo(6.7485f, 11.9012f, 6.768f, 11.8036f, 6.8058f, 11.7124f)
                curveTo(6.8436f, 11.6213f, 6.899f, 11.5386f, 6.9689f, 11.4689f)
